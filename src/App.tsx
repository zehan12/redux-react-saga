        ...
        <section className='main-content'>
          ...
          <div className="card">
            <div className='max-w-3xl'>
              <p className='p-3 leading-loose line-clamp-5'>
            ...
            <button className='w-28 h-10 bg-white text-black hover:text-red-700 font-semibold rounded-lg capitalize hover:bg-purple-50'>
              get started
            </button>
          </div>
        </section>
